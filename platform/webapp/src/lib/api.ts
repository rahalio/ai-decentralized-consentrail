const API_KEY_STORAGE = 'consentrail_api_key';
const ROLE_STORAGE = 'consentrail_role';
...
export function getApiKey() {
  return localStorage.getItem(API_KEY_STORAGE) ?? 'consentrail_demo_local_dev_key';
}
...
export function getRole(): OperatorRole {
  return (localStorage.getItem(ROLE_STORAGE) as OperatorRole) || 'dpo';
}
