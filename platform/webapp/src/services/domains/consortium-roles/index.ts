/**
 * ConsortiumRoles Domain
 *
 * Barrel export for consortium-roles service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { consortium-rolesService } from './consortium-roles.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { consortium-rolesFacade } from './facade';
...
} from './consortium-roles.api-types';
