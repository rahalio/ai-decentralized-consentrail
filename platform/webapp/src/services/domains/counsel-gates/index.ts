 ...
 * CounselGates Domain
 *
 * Barrel export for counsel-gates service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { counsel-gatesService } from './counsel-gates.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { counsel-gatesFacade } from './facade';
