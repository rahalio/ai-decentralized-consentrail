/**
 * RegulatorViews Domain
 *
 * Barrel export for regulator-views service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { regulator-viewsService } from './regulator-views.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { regulator-viewsFacade } from './facade';
...
} from './regulator-views.api-types';
