/**
 * TripleBlindExchange Domain
 *
 * Barrel export for triple-blind-exchange service, types, hooks, and view models.
 *
 * Architecture Rules:
 * - API types: re-exports from @consentrail/core only
...
// ============================================================================
export { triple-blind-exchangeService } from './triple-blind-exchange.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { triple-blind-exchangeFacade } from './facade';
...
} from './triple-blind-exchange.api-types';
