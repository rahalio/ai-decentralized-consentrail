/**
 * SecurityEvents Domain
 *
 * Barrel export for security-events service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { security-eventsService } from './security-events.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { security-eventsFacade } from './facade';
...
} from './security-events.api-types';
