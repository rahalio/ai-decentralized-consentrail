/**
 * SecurityEvents Services - Application Layer Export
 *
...
/**
 * SecurityEvents Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for security-events domain.
 */
