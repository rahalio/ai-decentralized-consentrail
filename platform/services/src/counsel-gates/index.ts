/**
 * CounselGates Services - Application Layer Export
 *
...
/**
 * CounselGates Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for counsel-gates domain.
 */
