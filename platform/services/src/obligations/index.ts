/**
 * Obligations Services - Application Layer Export
 *
...
/**
 * Obligations Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for obligations domain.
 */
