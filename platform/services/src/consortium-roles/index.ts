/**
 * ConsortiumRoles Services - Application Layer Export
 *
...
/**
 * ConsortiumRoles Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for consortium-roles domain.
 */
