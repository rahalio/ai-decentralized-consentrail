/**
 * DecideRepositoryDdb - sandbox implementation for local Consentrail.
 */
import type { DecideRepository } from "@consentrail/services/counsel-gates";
...
export class DecideRepositoryDdb implements DecideRepository {
  ...
  async decideCounselGate(input: any) {
