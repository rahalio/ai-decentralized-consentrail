/**
 * DisableRepositoryDdb - sandbox implementation for local Consentrail.
 */
import type { DisableRepository } from "@consentrail/services/triple-blind-exchange";
...
export class DisableRepositoryDdb implements DisableRepository {
  ...
  async disableTripleBlindPolicy(input: any) {
